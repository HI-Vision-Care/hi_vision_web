...
const RecentPostList: React.FC<RecentPostListProps> = ({ onEdit }) => {
  ...
  const { data: detail, isLoading: detailLoading } = useGetBlogPostDetail(
    selectedPostId ?? ""
  );
  ...
  const calculateReadingTime = (contents: any[]) => {
    ...
    const totalWords = contents.reduce((total, content) => {
      const headerWords = content.header
        ? content.header.split(/\s+/).length
        : 0;
        ...
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="text-gray-500 mb-4">
              There was an error loading your blog posts. Please try again.
            </p>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="text-gray-500 mb-4">
              You haven&apos;t created any blog posts yet. Start writing your
              first post!
            </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {posts.map((post) => {
            ...
            return (
              <Card
                key={post.id}
                className={`group hover:shadow-xl transition-all duration-300 cursor-pointer border-2 hover:border-blue-200 bg-white overflow-hidden p-0 relative ${
                  post.hide
  ...
  `}
                ...
                <CardHeader className="pb-3 min-h-[100px]">
                  ...
                  <div className="flex items-center justify-between gap-2 mb-3">
                    ...
                    <div
                      className={`flex items-center gap-1 text-xs ${
                        isHide ? "text-gray-400" : "text-gray-500"
                      }`}
                    >
                  ...
                  {/* Title */}
                  <CardTitle
                    className={`text-lg font-semibold leading-tight line-clamp-2 transition-colors ${
                      isHide
                ...
                <CardContent className="pt-0 mb-[10px]">
                  ...
                  <div
                    className={`flex items-center gap-2 text-sm mb-3 ${
                      isHide ? "text-gray-400" : "text-gray-600"
                    }`}
                  >
          ...
          <DialogHeader className="pb-4">
            <div className="flex items-center justify-between">
              <DialogTitle className="text-xl font-semibold pr-8">
                {detailLoading
                  ? "Loading..."
                  : detail?.title || "Blog Post Details"}
              </DialogTitle>
            </div>
          </DialogHeader>
              ...
              <div className="space-y-6">
                ...
                {detail.banner && (
                  <div className="relative aspect-video w-full bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden rounded-lg">
                    <img
                      src={
                        detail.banner || "/placeholder.svg?height=300&width=600"
                      }
                ...
                <div className="space-y-4">
                  <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        {calculateReadingTime(detail.contents)} min read
                      </span>
                    </div>
                  </div>
